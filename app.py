...
# Base64 인코딩된 이미지 경로
image_base64 = get_base64_image("map3.png")
...
st.markdown(
    ...
    <style>
        ...
        div.stButton > button {
             ...
             overflow: hidden; /* 넘치는 텍스트 숨김 */
             text-overflow: ellipsis; /* 넘치는 텍스트를 말줄임표로 표시 */
             font-size: 2em !important;  /* 버튼 글자 크기만 키우기 */
        }
...
if current_page_value == "main":
    ...
    st.markdown("""
        <div style="
            ...
            text-align: center; /* 텍스트 중앙 정렬 */
        ">
            <h2 style="color: white; text-align: center;">서울시 고령층 만성질환 의료 공급 대비 수요 격차 맵</h2>
        </div>
    """, unsafe_allow_html=True)
